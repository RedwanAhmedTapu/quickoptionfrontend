...
.devices__item svg {
 ...
 .devices__item:hover:not(.devices__item--active) {
 border-color: #fff;
 color: #fff
}
          ...
          <div className="webapps-content applications__in flex gap-[120px] justify-between items-center">
            {/* <ul className="devices">
              <li className="devices__item">
                <a href="https://pomain.onelink.me/PuH1?af_js_web=true&amp;af_ss_ver=2_9_3&amp;pid=web_to_app&amp;from_alanbase=0&amp;web2app=web2app&amp;afsite_id=web2app&amp;af_ss_ui=true" target="_blank" className="devices__btn devices__btn_ios js-android-link js-google-play-main-app" data-name="svg-link" data-layout="{&quot;event&quot;:&quot;gtm_events&quot;,&quot;ga4_event_name&quot;:&quot;go_to_store_from_main&quot;,&quot;store_name&quot;:&quot;android&quot;}">
                  <div className="devices__top">
                    <svg className="svg-icon android" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M5.16142 6.84262C5 7.32688 5 7.97257 5 8.61825V54.6232C5 55.2689 5 55.7531 5.16142 56.3988L30.9887 31.0557L5.16142 6.84262Z" fill="currentColor" className="android__layer-1"></path>
                      <path d="M30.1816 31.54L43.0953 18.7878L15.1695 2.96852C14.2009 2.32284 12.9096 2 11.6182 2C8.55121 2 5.80706 4.09847 5.16138 6.84262L30.1816 31.54Z" fill="currentColor" className="android__layer-2"></path>
                      <path d="M30.0202 30.2486L5.16138 56.2374C5.96848 58.9815 8.55121 61.08 11.6182 61.08C12.9096 61.08 14.0395 60.7572 15.008 60.1115L43.0953 44.1308L30.0202 30.2486Z" fill="currentColor" className="android__layer-3"></path>
                      <path d="M55.2018 25.7288L43.0952 18.7877L29.5359 30.7328L43.2567 44.1308L55.3632 37.3511C57.4617 36.2211 58.9145 33.9612 58.9145 31.5399C58.753 29.1186 57.3003 26.8587 55.2018 25.7288Z" fill="currentColor" className="android__layer-4"></path>
                    </svg>
              ...
              <li className="devices__item">
                <a href="https://poa.onelink.me/RCtj?af_js_web=true&amp;af_ss_ver=2_9_3&amp;pid=web_to_app&amp;c=apk&amp;from_alanbase=0&amp;web2app=web2app&amp;afsite_id=web2app&amp;af_ss_ui=true" target="_blank" className="devices__btn devices__btn_ios js-apk-link js-apk-main-app" data-name="svg-link" data-layout="{&quot;event&quot;:&quot;gtm_events&quot;,&quot;ga4_event_name&quot;:&quot;go_to_store_from_main&quot;,&quot;store_name&quot;:&quot;apk&quot;}">
                  <div className="devices__top">
                    <svg className="svg-icon apk" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="flex flex-1 gap-5">
              ...
              <a className="group flex-1 cursor-pointer">
                <div className="bg-[#eef2f9] rounded-3xl flex flex-col items-center pt-8 pb-4 px-0">
                  <img src="../../public/images/icons/google-play.png" className="size-[64px] mb-3 grayscale group-hover:grayscale-0 transition-all duration-500" alt="Play Store" />
                  <p className="text-lg font-semibold">Android</p>
                </div>
                <h1 className="underline decoration-blue-300 underline-offset-8 text-2xl text-center mt-3 group-hover:text-blue-300 transition-all duration-150">Download</h1>
              </a>

              <a className="group flex-1 cursor-pointer">
                <div className="bg-[#eef2f9] rounded-3xl flex flex-col items-center pt-8 pb-4 px-0">
                  <img src="../../public/images/icons/download-coloured.png" className="size-[64px] mb-3 grayscale group-hover:grayscale-0 transition-all duration-500" alt="Play Store" />
                  <p className="text-lg font-semibold">Apk Download</p>
                </div>
                <h1 className="underline decoration-blue-300 underline-offset-8 text-2xl text-center mt-3 group-hover:text-blue-300 transition-all duration-150">Download</h1>
              </a>
              ...
              <a className="group flex-1 cursor-pointer">
                <div className="bg-[#eef2f9] rounded-3xl flex flex-col items-center pt-8 pb-4 px-0">
                  <img src="../../public/images/icons/online-service.png" className="size-[64px] mb-3 grayscale group-hover:grayscale-0 transition-all duration-500" alt="Play Store" />
                  <p className="text-lg font-semibold">Web App</p>
                </div>
                <h1 className="underline decoration-blue-300 underline-offset-8 text-2xl text-center mt-3 group-hover:text-blue-300 transition-all duration-150">Open</h1>
              </a>

              <a className="group flex-1 cursor-pointer">
                <div className="bg-[#eef2f9] rounded-3xl flex flex-col items-center pt-8 pb-4 px-0">
                  <img src="../../public/images/icons/telegram.png" className="size-[64px] mb-3 grayscale group-hover:grayscale-0 transition-all duration-500" alt="Play Store" />
                  <p className="text-lg font-semibold">Telegram bot</p>
                </div>
                <h1 className="underline decoration-blue-300 underline-offset-8 text-2xl text-center mt-3 group-hover:text-blue-300 transition-all duration-150">Subscribe</h1>
              </a>
