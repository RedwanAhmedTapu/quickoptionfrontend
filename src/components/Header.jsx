      ...
      <div className="w-full max-w-6xl  flex justify-between items-center px-6 py-4 relative z-50">
        ...
        <div className="flex items-center gap-3">
          <img
            ...
            className="w-14 h-14"
            alt="PocketOption Logo"
          />
          <span
            className={`text-xl font-bold ${
              isScrolled ? "text-[#2193b0]" : "text-white"
            }`}
          >
        ...
        <nav className="hidden lg:flex space-x-24 text-base font-medium">
          <a
            href="#"
            className={
              isScrolled ? "hover:text-[#2193b0]" : "hover:text-[#6dd5ed]"
            }
          >
            Quick start
          </a>
        ...
        <div className="flex items-center gap-6">
          <button
            className={`hidden sm:flex items-center gap-2 text-base ${
              isScrolled ? "hover:text-[#2193b0]" : "hover:text-[#6dd5ed]"
            }`}
          >
            <Globe size={20} />
              ...
              >
                ...
                <ul className="space-y-3">
                  <li>
                    <a
                      href="#"
                      className="hover:text-blue-100 text-lg transition-colors"
                    >
                      Free demo
                    </a>
                  </li>
